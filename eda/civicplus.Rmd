...
Here's an .rds file of 2,220 .pdfs downloaded by `civicplus.R` on `Sys.Date()`
...
Let's see what these documents cover. Here are the states and provinces for which we have documents:
